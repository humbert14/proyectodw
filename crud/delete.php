...
<div class="container">
	...
	if(isset($_GET['deleted']))
	{
    	...
    	<strong>Success!</strong> Registro Eliminado
		</div>
        <?php
	}
	else
	{
    	...
    	<strong>Sure !</strong> Eliminar el siguiente registro? 
		</div>
        <?php
	}
	?>	
...
{
	?>
    <a href="index.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Ir A lista</a>
    <?php
}
?>
</p>
